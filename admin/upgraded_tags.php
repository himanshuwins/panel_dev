...
<table style="width:90%;margin:auto;font-size:1.5em;color:#333;" border="0" cellpadding="3px" cellspacing="0" class="breadcrumb">
  <tr>
    <td><a href="index.php">Dashboard</a> > Tags Upgraded in Last Session</td>
  </tr>
</table><br>
...
{
	$res=$new_conn->query("SELECT DISTINCT(tag) FROM wb_ud WHERE tag_upgraded_session='yes' AND tag!='company' AND tag!='Executive' ORDER BY tag");
...
<table style="width:90%;margin:auto;font-size:1em;color:#FFF;" border="0" cellpadding="3px" cellspacing="0">
  <tr>
    <td align="right" colspan="2">
      ...
      <input type="button" value="Reset" onClick="window.location.href='upgraded_tags.php'" /></td>
  </tr>
</table><br>
...
else
{
	...
	$sno=1;
	$prep="SELECT a.* FROM wb_ud a WHERE tag_upgraded_session='yes' AND tag!='Executive' AND tag!='company' ";
	if($search_tag!="any")
	{
