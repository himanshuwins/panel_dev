    ...
    <tr>
      ...
      <td colspan="2"><form method="post" name="sendmsg" onSubmit="return checkForm(this);">
          <table width="98%" border="0" align="center" cellpadding="5" cellspacing="0" class="arial11">
            ...
            <tr>
              <td class="arialblack12"><strong>Domain :</strong></td>
              <td colspan="2"><input name="msg_body" type="text" class="form2" id="msg_body" placeholder="Domain Name Here..." style="width:350px;" />
              </td>
            </tr>
            <tr>               
