...
if(!empty($_POST))
{
	...
	else
	{
		...
		if($res->num_rows==1)
		{
			...
			$new_conn->close();
			$msg="";
			$temp_filename="activate_deactivate.php?id=".$detail['table_id'];
...
<head>
<meta charset="utf-8">
<title>Activate / Deactivate Users</title>
...
<table style=";margin:auto;" border="0" cellpadding="0" cellspacing="0">
  <tr style="height:100px;">
    <td align="center"><h2 style="color:#333;">Activate / Deactivate IDs</h2></td>
  </tr>
  <tr>
    <td>
      <fieldset style="padding:20px;">
        <legend>ENTER USERNAME TO CHANGE</legend>
