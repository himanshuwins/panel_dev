...
<table style="width:90%;margin:auto;font-size:1.5em;color:#333;" border="0" cellpadding="3px" cellspacing="0" class="breadcrumb">
  <tr>
    <td><a href="index.php">Dashboard</a> > Stopped Income List</td>
  </tr>
</table><br>
...
<table style="width:90%;margin:auto;font-size:1em;color:#FFF;" border="0" cellpadding="3px" cellspacing="0">
  <tr>
    <td align="right" colspan="2">
      ...
      <input type="button" value="Reset" onClick="window.location.href='stopped_income_list.php'" /></td>
  </tr>
</table><br>
...
else
{
	...
	else
	{
		...
		$prep="SELECT SQL_CALC_FOUND_ROWS a.*,DATE(a.created_date) AS income_date,b.* FROM wb_ch a INNER JOIN wb_ud b ON b.table_id=a.id WHERE a.payment_status='stopped' ";
		if($search_username!="")
		{
		...
		while($detail=$res->fetch_assoc())
		{
			...
			echo("<td style=\"background-color:#333;color:#FFF;font-weight:bold\">".$detail['payment_status']."</td>");
			echo("</tr>");
			$sno++;
		}
	}
