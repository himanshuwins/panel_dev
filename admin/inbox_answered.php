...
else
{
	...
	$res=$new_conn->query("SELECT SQL_CALC_FOUND_ROWS a.*,b.username FROM wb_msg a INNER JOIN wb_ud b ON b.table_id=a.by_id WHERE a.for_id='admin' AND subject!='Domain Registration' AND a.last_reply_by='admin' ORDER BY a.datetime DESC LIMIT $start,$per_page");
