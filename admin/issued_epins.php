...
<table style="width:90%;margin:auto;font-size:1.5em;color:#333;" border="0" cellpadding="3px" cellspacing="0" class="breadcrumb">
  <tr>
    <td><a href="index.php">Dashboard</a> > Issued E-Pins</td>
  </tr>
</table><br>
...
if($pages>1)
{
	...
	for($i=1;$i<=$pages;$i++)
	{
		...
		{
			echo("<td>&nbsp;<a href=\"issued_epins.php?page=".$j."\">".$i."</a>&nbsp;</td>");
		}
	}
	echo("</tr>");
}
