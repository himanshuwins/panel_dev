...
if(!empty($_POST))
{
	...
	else
	{
		...
		if($res->num_rows==1)
		{
			...
			$new_conn->close();
			header("Location: /panel/admin/register_domain.php?ref_id=".$detail['table_id']."&url_post=view_user_domain.php");
		}
		else
		{
			$new_conn->close();
...
<table style=";margin:auto;" border="0" cellpadding="0" cellspacing="0">
  <tr style="height:100px;">
    <td align="center"><h2 style="color:#333;">VIEW USER DOMAIN DETAILS</h2></td>
  </tr>
  <tr>
    <td>
