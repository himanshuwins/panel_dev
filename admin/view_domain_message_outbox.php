...
{
	$res=$new_conn->query("SELECT a.*,b.username FROM wb_msg a INNER JOIN wb_ud b ON b.table_id=a.for_id WHERE a.table_id='$msg_id' AND a.by_id='admin'");
	if($res->num_rows==1)
	{
...
<table style="width:90%;margin:auto;font-size:1.5em;color:#333;" border="0" cellpadding="3px" cellspacing="0" class="breadcrumb">
  <tr>
    <td><a href="index.php">Dashboard</a> > <a href="outbox.php">Outbox</a> > View Message</td>
  </tr>
</table><br>
<table style="width:90%;margin:auto;font-size:1em;color:#333;" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr style="height:50px;">
    <td align="right"><div class="buttons" onClick="window.location.href = 'domain_outbox.php';" style="background-color:#900;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
  </tr>
</table>
<br><br>
</div>
